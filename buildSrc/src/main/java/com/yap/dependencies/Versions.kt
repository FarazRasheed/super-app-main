    ...
    object AndroidXVersions {
        ...
        const val VECTOR_DRAWABLE = "1.1.0-beta02"
    ...
    object FireBaseVersions {
        ...
        const val MESSAGING_FCM = "20.3.0"
        const val PLAY_SERVICES_PLACES = "16.0.0"
        const val PLAY_LIB_PLACE = "1.1.0"
    ...
    object KotlinVersions {
        const val STANDARD_LIBRARY = "1.3.50"
        const val COROUTINE_VERSION = "1.3.0-M1"
    }
